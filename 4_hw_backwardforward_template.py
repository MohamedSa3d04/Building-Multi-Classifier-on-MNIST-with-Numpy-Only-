...
def backward(X_batch, y_batch, W2, W3, out1, out2, out3):
    ...
    dE_dout2 = np.dot(dE_dnet3, W3.T)      # TODO
    dE_dnet2 = dE_dout2 * dtanh(out2)  # TODO
    ...
    db2 = np.sum(dE_dnet2, axis=0, keepdims=True)         # TODO
    dW1 = np.dot(X_batch.T, dE_dnet1)       
    db1 = np.sum(dE_dnet1, axis=0, keepdims=True)          # TODO
...
if __name__ == '__main__':
    # load inputs needed for backward
